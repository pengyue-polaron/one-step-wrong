...
function SharedDraftScene({ definition, onSelect }: DecisionSceneProps) {
  return (
    <section className="tool-window drive-window" aria-label="NYU Drive sharing settings">
      ...
      <div className="drive-layout">
        ...
        <aside className="share-dialog">
          ...
          <div className="share-request"><span className="avatar">M</span><div><strong>Maya Chen</strong><p>&ldquo;NYU login is acting up. Send it to maya.chen.nyu@gmail.com for now.&rdquo;</p></div></div>
